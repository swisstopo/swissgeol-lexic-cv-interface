            ...
            {loading ? (
                ...
                <Box>
                    <Select
                        ...
                        components={{ Control, DropdownIndicator: null, ClearIndicator: () => null }}
                        styles={{
                            ...
                            option: (provided, state) => ({
                                ...
                                borderRadius: 4,
                                fontSize: '14px',
                                color: state.isFocused || state.isSelected ? '#2F4356' : '#337083',
                                backgroundColor: state.isFocused || state.isSelected ? '#D6E2E6' : 'white',
                                ':active': {
                            ...
                            menu: (provided) => ({
                                ...
                                boxShadow: '4px 4px 2px 0px rgba(0, 0, 0, 0.12)',
                                marginTop: '10px',
                                zIndex: 9999,
                                overflow: 'hidden',
                            }),
