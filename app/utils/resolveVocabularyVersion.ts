...
export async function resolveVocabularyVersion(vocabulary: 'Chronostratigraphy' | 'TectonicUnits' | 'TectonicStructures' | 'Lithostratigraphy' | 'Lithology' | 'ls_correlations' | 'materialDescription'): Promise<string> {
  try {
